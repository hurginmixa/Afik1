...
function editor_generate(objname,userConfig) {
  ...
  + toolbar
//RTL & LTR 
+ '<table border=0 cellspacing=2 cellpadding=0 bgcolor="buttonface" style="float: left;" unselectable="on"><tr><td style="border: inset 0px;">\n' 
+ '<button title="Left - To - Right" id="_' +objname+ '_blockDirLTR" class="btn" onClick="editor_action(this.id)" unselectable="on"><img src="' +config.imgURL+ 'ed_ltr.gif" unselectable="on"></button>' 
+ '<button title="Right - To - Left" id="_' +objname+ '_blockDirRTL" class="btn" onClick="editor_action(this.id)" unselectable="on"><img src="' +config.imgURL+ 'ed_rtl.gif" unselectable="on"></button>' 
+ '</td></tr></table>\n' 
  + '</td></tr></table>\n'
  + '</td></tr></table></span>\n'
